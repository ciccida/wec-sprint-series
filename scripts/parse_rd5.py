...
HTML_FILE = "/Users/kentachida/Downloads/2026_07_04_22_39.Paul Ricard - ELMS.html"
...
def process_results():
    ...
    with open("rd5_parsed.json", "w", encoding='utf-8') as f:
        json.dump(round_results, f, indent=4, ensure_ascii=False)
    print("Written rd5_parsed.json")
