...
HTML_FILE = "/Users/kentachida/Downloads/2026_07_18_22_39.Sebring International Raceway.html"
...
def process_results():
    ...
    with open("rd6_parsed.json", "w", encoding='utf-8') as f:
        json.dump(round_results, f, indent=4, ensure_ascii=False)
    print("Written rd6_parsed.json")
