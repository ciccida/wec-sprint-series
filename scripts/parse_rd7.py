...
HTML_FILE = "/Users/kentachida/Downloads/2026_08_01_22_39.Circuit de Spa-Francorchamps.html"
...
def process_results():
    ...
    with open("rd7_parsed.json", "w", encoding='utf-8') as f:
        json.dump(round_results, f, indent=4, ensure_ascii=False)
    print("Written rd7_parsed.json")
